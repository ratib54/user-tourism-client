...
const Navbar = () => {
 ...
 const navLinkStyle = ({ isActive }) =>
  `text-lg font-medium block px-4 py-2 rounded-md transition duration-300 ${isActive
   ? 'text-black bg-[#fff] shadow-md'
   : 'text-white hover:bg-green-500/20'
  }`;

 return (
  <nav className="fixed top-2 lato rounded-3xl w-full z-50 bg-gradient-to-r from-[#89cadb] to-[#347698] shadow-lg">
